...
public class DialogUtil {
     ...
     * @param iconId   图标，如：R.drawable.icon 或 DialogUtil.NO_ICON 必填
     * @param title    标题 必填
     * @param message  显示内容 必填
     * @param btnName  按钮名称 必填
     * @param listener 监听器，需实现android.content.DialogInterface.DialogInterface.OnClickListener接口 必填
     * @return
     * @description 创建消息对话框
     */
    @SuppressLint("NewApi")
     ...
     * @param positiveBtnListener 监听器，需实现android.content.DialogInterface.DialogInterface.OnClickListener接口 必填
     * @param negativeBtnListener 监听器，需实现android.content.DialogInterface.DialogInterface.OnClickListener接口 必填
    ...
    public static Dialog createConfirmDialog(Context context, String title,
                                             ...
                                             DialogInterface.OnClickListener negativeBtnListener, int iconId, boolean flag) {
        Dialog dialog = null;
        AlertDialog.Builder builder = new AlertDialog.Builder(context,
                AlertDialog.THEME_HOLO_LIGHT);
     ...
     * @param positiveBtnListener 监听器，需实现android.content.DialogInterface.DialogInterface.OnClickListener接口 必填
     * @param negativeBtnListener 监听器，需实现android.content.DialogInterface.DialogInterface.OnClickListener接口 必填
     * @param itemClickListener   监听器，需实现android.content.DialogInterface.DialogInterface.OnClickListener接口 必填
     * @return
     * @description 创建单选对话框
     */
    public static Dialog createSingleChoiceDialog(Context context,
                                                  ...
                                                  DialogInterface.OnClickListener itemClickListener, int iconId, boolean flag) {
        Dialog dialog = null;
        AlertDialog.Builder builder = new AlertDialog.Builder(context);
    ...
    public static Dialog createMultiChoiceDialog(Context context, String title,
                                                 ...
                                                 String negativeBtnName, DialogInterface.OnClickListener positiveBtnListener,
                                                 DialogInterface.OnClickListener negativeBtnListener,
                                                 DialogInterface.OnMultiChoiceClickListener itemClickListener, int iconId,
                                                 boolean flag) {
        Dialog dialog = null;
        AlertDialog.Builder builder = new AlertDialog.Builder(context);
    ...
    public static Dialog createEnsureDialog(Context context, View aboutView2,
                                            ...
                                            DialogInterface.OnClickListener positiveBtnListener, int iconId, boolean flag) {
        Dialog dialog = null;
        AlertDialog.Builder builder = new AlertDialog.Builder(context,
                AlertDialog.THEME_HOLO_LIGHT);
